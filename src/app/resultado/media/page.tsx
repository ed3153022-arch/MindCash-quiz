    ...
    <div className="min-h-screen bg-black text-white p-4">
      <div className={`max-w-4xl mx-auto transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {result.blocks.map((block, index) => (
              <div key={index} className="flex items-start">
                <div className="w-6 h-6 bg-red-500/20 border border-red-500 rounded-full flex items-center justify-center mr-3 mt-0.5 flex-shrink-0">
        ...
        <div className="bg-gradient-to-r from-[#D4AF37]/10 to-[#FFD700]/10 rounded-2xl p-8 border border-[#D4AF37]/30 mb-12">
          <h3 className="text-2xl font-semibold mb-6 text-[#D4AF37]">🎯 Como Fortalecer Seu Controle nos Próximos 7 Dias</h3>
          <div className="grid md:grid-cols-2 gap-6">
